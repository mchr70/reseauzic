...
// Returns the private 'App\Repository\InstrumentallevelbyuserRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\InstrumentallevelbyuserRepository.php';

return $this->privates['App\Repository\InstrumentallevelbyuserRepository'] = new \App\Repository\InstrumentallevelbyuserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
