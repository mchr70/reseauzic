...
// Returns the private 'App\Repository\LevelRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\LevelRepository.php';

return $this->privates['App\Repository\LevelRepository'] = new \App\Repository\LevelRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
