 ...
 */
final class Version20190227132623 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD photo_src VARCHAR(255) DEFAULT NULL, ADD photo_alt VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP photo_src, DROP photo_alt');
    }
}
