 ...
 */
final class Version20190227084041 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE photo src_photo VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE src_photo photo VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
