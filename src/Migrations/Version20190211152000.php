 ...
 */
final class Version20190211152000 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message CHANGE user_id user_sender_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message CHANGE user_sender_id user_id INT NOT NULL');
