 ...
 */
final class Version20190211151136 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_instrument_level (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, instrument_id INT NOT NULL, level_id INT DEFAULT NULL, INDEX IDX_3F253AA7A76ED395 (user_id), INDEX IDX_3F253AA7CF11D9C (instrument_id), INDEX IDX_3F253AA75FB14BA7 (level_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
