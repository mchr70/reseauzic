 ...
 */
final class Version20190227102346 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP src_photo, DROP alt_photo');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD src_photo VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, ADD alt_photo VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}
