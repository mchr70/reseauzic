 ...
 */
final class Version20190305125721 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE thread (id INT AUTO_INCREMENT NOT NULL, user_creator_id INT NOT NULL, user_recipient_id INT NOT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_31204C83C645C84A (user_creator_id), INDEX IDX_31204C8369E3F37A (user_recipient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE upload (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(64) NOT NULL, is_active TINYINT(1) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', birth_date DATE DEFAULT NULL, registration_date DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, gender TINYINT(1) DEFAULT NULL, zip_code VARCHAR(64) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, address LONGTEXT DEFAULT NULL, phone VARCHAR(50) DEFAULT NULL, about LONGTEXT DEFAULT NULL, influences LONGTEXT DEFAULT NULL, material LONGTEXT DEFAULT NULL, photo_src VARCHAR(255) DEFAULT NULL, photo_alt VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
